...
int resistencia[TAMANHO][50];      // Recebe o valor da quantidade de dano que ela tem que sofrer em um único turno para ser destruída.
float preco_medio[TAMANHO][50];      // Recebe o valor do preço médio em reais qua a carta custa.
